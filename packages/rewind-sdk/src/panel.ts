...
const historyIcon = '<svg viewBox="0 0 20 20" aria-hidden="true"><path d="M5 4.5h6M5 10h10M5 15.5h6"/><circle cx="3" cy="4.5" r="1"/><circle cx="17" cy="15.5" r="1"/></svg>';
