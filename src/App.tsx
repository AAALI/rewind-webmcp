...
function App() {
  return <div className="site">
    ...
    <main>
      ...
      <section id="sdk" className="sdk"><div><p className="kicker">THE SDK</p><h2>Record at the mutation boundary.</h2><p>Rewind sits underneath the interface. Each mutating WebMCP tool creates a commit with before state, after state, effects and a deterministic hash. The host product decides where contextual Undo appears.</p><ul><li><History size={15}/> Background action history</li><li><RotateCcw size={15}/> Snapshot restore</li><li><GitBranch size={15}/> Branch-on-retry audit trail</li></ul></div><pre><code>{`const rewind = createRewindEngine({ initialState });
